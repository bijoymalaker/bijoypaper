      ...
      <div class="col-lg-9">
        <nav class="navbar navbar-expand-sm bg-dark p-0">
          <ul class="navbar-nav ml-n2">
            ...
            <li class="nav-item">
              <a class="nav-link text-body small" href="admin/dashboard.php">Admin</a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <div class="col-lg-4">
        <a href="index.php" class="navbar-brand p-0 d-none d-lg-block">
          <h1 class="m-0 display-4 text-uppercase text-primary">
            Bijoy<span class="text-secondary font-weight-normal">paper</span>
          </h1>
        </a>
      </div>
    </div>
  ...
  <div class="container-fluid p-0">
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
      <a href="index.html" class="navbar-brand d-block d-lg-none">
        <h1 class="m-0 display-4 text-uppercase text-primary">
          Bijoy<span class="text-white font-weight-normal">PAPER</span>
        </h1>
      </a>
